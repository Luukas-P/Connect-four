...
Before you can start a game you need to choose colors for both players. After you
have done that you get a messagebox that the game can begin and you can start the
game.

The chosen colors are shown under the game board and on top of the game board
is the score counter that keeps count of the players wins.

In the top left corner on the screen is a menu where you can check the rules of t
he game or quit.

After a game is over a messagebox shows the player that won or if it was a draw
and updates the score before a new game can be played.

In the instance that you try to place a piece on board before you choose colors you
get an error messagebox.

After the colors have been chosen you can't change them anymore
"""
from tkinter import *
